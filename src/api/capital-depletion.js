...
export default {
	capitalDepletion_getAmountPerWithdrawl: function (presentValue, years, withdrawls, frequency, returnPercentage) {
	...
	capitalDepletion_getTotalPayout: function (amountPerWithdrawl, years, withdrawls) {
