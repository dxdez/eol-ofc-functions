...
exports.handler = async (event, context) => {
  ...
  switch (mode) {
    case "annual-compound-return":
      result = RateOfReturn.getRateOfReturnAnnualCompoundReturn(
        av,
        pv,
        dy,
        dm,
    ...
    case "total-percentage-gain":
      result = RateOfReturn.getRateOfReturnTotalPercentageGain(
        av,
        pv,
        dy,
        dm,
    ...
    case "lumpsum-annual-compound-return":
      result = RateOfReturn.getRateOfReturnLumpSumAnnualCompoundReturn(
        li,
        pv,
        dy,
        dm
    ...
    case "lumpsum-average-annual-gain":
      result = RateOfReturn.getRateOfReturnLumpSumAverageAnnualGain(
        li,
        pv,
        dy,
        dm
