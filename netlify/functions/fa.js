...
exports.handler = async (event, context) => {
  ...
  switch (mode) {
    case "periodic-investment":
      result = FutureAmount.getFutureAmountPeriodicInvestment(
        ra,
        ar,
        dy,
        dm,
    ...
    case "periodic-lumpsum-investment":
      result = FutureAmount.getFutureAmountPeriodicLumpSumInvestment(
        ra,
        ar,
        at,
        dy,
    ...
    case "leveraged-required-lumpsum":
      result = FutureAmount.getFutureAmountLeveragedRequiredLumpSumLeveraged(
        ra,
        dy,
        acr
      );
    ...
    case "leveraged-value-balance-after-loan":
      result = FutureAmount.getFutureAmountLeveragedValueBalanceAfterLoan(
        ra,
        dy,
        acr
      );
